...
(function() {
  ...
  window.dermis = {
    ...
    model: function(o) {
      return mixer.create(dermis.model.base).extend(o).create();
    },
    collection: function(o) {
      return mixer.create(dermis.model.base).extend(dermis.collection.base).extend(o).create();
    },
  ...
  dermis.collection.base = {
    isCollection: true,
    create: function(o) {
      return mixer.create(this.clone(), o).set('items', []);
    },
  ...
  _ref = dermis.binding.formatters;
  for (k in _ref) {
    v = _ref[k];
    rivets.formatters[k] = v;
  }

  _ref1 = dermis.binding.routines;
  for (k in _ref1) {
    v = _ref1[k];
    rivets.routines[k] = v;
  }
